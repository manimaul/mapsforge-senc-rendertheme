...
if options.translationMethod:
    print os.path.join(os.path.abspath(__file__), "translations")
    ...
    elif os.path.isfile(os.getcwd() + "/translations/" + options.translationMethod):
        sys.path.insert(0, os.getcwd() + "/translations")
    elif os.path.exists(os.path.dirname(__file__) +"/translations"):
        sys.path.insert(0, os.path.dirname(__file__) +"/translations")
